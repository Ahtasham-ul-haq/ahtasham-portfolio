    ...
    return (
        <div className='py-20' id='projects'>
            ...
            <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8 mt-10'>
                {projects.map(({ id, title, des, img, iconLists, liveLink, githubLink }) => (
                            ...
                            <div className='flex items-center justify-between mt-7'>
                                ...
                                <div className='flex items-center justify-center gap-4'>
                                    <div className='flex items-center justify-center p-2 rounded-lg'>
                                        <Link target='_blank' href={githubLink} className='flex lg:text-xl md:text-xs text-sm text-purple'>Code</Link>
                                        <FaEye className='ml-2 mt-1' color='#CBACF9' />
                                    </div>
                                    <div className='flex items-center justify-center bg-[#161A31] p-2 rounded-lg'>
                                        <Link target='_blank' href={liveLink} className='flex lg:text-xl md:text-xs text-sm text-white'>Live Site</Link>
